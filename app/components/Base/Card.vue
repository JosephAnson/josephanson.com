...
<template>
  <div :class="cn('flex flex-col w-full overflow-hidden rounded-xl transition-all !duration-300 hover:shadow-xl !hover:scale-[1.02] h-full', classes.card, $attrs.class as string)">
    <div
      v-if="props.image"
